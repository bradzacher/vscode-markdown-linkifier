...
export function activate(extensionContext: vscode.ExtensionContext): void {
    ...
    'plaintext',
    {
      provideCompletionItems(
        ...
        snippetCompletion.insertText = new vscode.SnippetString(
          // eslint-disable-next-line no-template-curly-in-string -- snippet string syntax
        ...
        // a completion item that re-triggers IntelliSense when being accepted,
  ...
  extensionContext.subscriptions.push(provider1, provider2);
}
